#!/bin/bash
# Evoformer AE Pipeline: Train + checkpoint sweep
# Usage: bash scripts/run_evoformer.sh [SPLIT] [EXTRA_ARGS...]
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --standalone --nproc_per_node=4 scripts/run_autoencoder_pipeline.py \
