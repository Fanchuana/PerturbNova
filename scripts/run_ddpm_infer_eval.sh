#!/bin/bash
# DDPM Inference + Cell Eval (after training)
#
# Usage:
#   bash scripts/run_ddpm_infer_eval.sh vae
#   bash scripts/run_ddpm_infer_eval.sh evoformer
#
# This script runs inference and cell_eval after training is complete.
...
# ============================================================================
# Step 2: Cell Eval (CPU only, release GPU)
# ============================================================================

echo "=========================================="
echo "Step 2: Cell Evaluation (CPU)"
echo "=========================================="
